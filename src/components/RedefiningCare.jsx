...
const RedefiningCare = () => {
  ...
  return (
    <section id="redefining" ref={sectionRef} className="relative w-full bg-[#07080a] text-white py-12 sm:py-20 md:py-32 px-4 sm:px-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto space-y-10 sm:space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
          ...
          <p className="max-w-md text-slate-400 text-xs sm:text-base font-normal leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 bg-[#0c0d10] shadow-2xl group">
              <img
              ...
              <div className="absolute top-4 left-4 sm:top-6 sm:left-6 pill-badge border-rose-500/30 bg-rose-500/10 text-rose-400">
          ...
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            {solutions.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="comparison-card glass-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-white/20 transition-all duration-300 flex items-start gap-4 sm:gap-5"
                >
                  ...
                  <div className="space-y-1 flex-1">
                    <div className="flex items-center justify-between">
                      <h3 className="font-display text-base sm:text-lg font-bold text-white tracking-wide">{item.title}</h3>
                      <span className="inline-flex items-center gap-1 font-mono text-[9px] sm:text-[10px] text-rose-400/80 uppercase">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-rose-500/20 via-rose-500/10 to-transparent border border-rose-500/30 space-y-2 mt-4 sm:mt-6">
              ...
              <h4 className="font-display text-lg sm:text-2xl font-bold text-white leading-snug">
                &quot;No existing product answers the critical question: <span className="text-rose-400">Why is my baby crying?</span>&quot;
              </h4>
              <p className="font-mono text-xs sm:text-sm uppercase text-slate-300 font-bold tracking-wider pt-1">
